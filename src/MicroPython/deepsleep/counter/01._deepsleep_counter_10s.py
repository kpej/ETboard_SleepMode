# ******************************************************************************************
# FileName     : deepsleep_counter_10s.py
# Description  : Deep Sleep 후 깨어났을 때 LED로 작업 중 표시 (10초 주기)
...
#===========================================================================================
    ...
    wake_count = get_wake_count()                        # 이전까지의 wake count 불러오기
    ...
    print(f"총 경과 시간: 약 {(wake_count - 1) * 10}초")
    ...
    machine.deepsleep(10000)                             # 10초 동안 Deep Sleep 진입
